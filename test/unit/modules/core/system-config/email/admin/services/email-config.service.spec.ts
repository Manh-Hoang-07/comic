...
describe('EmailConfigService', () => {
    ...
    describe('updateConfig', () => {
        it('should create new config if none exists', async () => {
            emailConfigRepo.getConfig.mockResolvedValue(null);
            emailConfigRepo.create.mockResolvedValue({ id: 1n, smtp_host: 'smtp.test.com' });
        ...
        it('should update existing config', async () => {
            const existing = { id: 1n, smtp_host: 'old.host.com', updated_user_id: 1n };
            ...
            expect(emailConfigRepo.update).toHaveBeenCalledWith(1n, expect.objectContaining({
        ...
        it('should keep old password if not provided in dto', async () => {
            ...
            expect(emailConfigRepo.update).toHaveBeenCalledWith(1n, expect.not.objectContaining({
