...
export class TokenService {
    ...
    private getRefreshSecret(): string { return this.config.get<string>('jwt.refreshSecret') as string; }
    ...
    generateTokens(userId: PrimaryKey, email?: string) {
        ...
        const refreshExpiresIn = (this.config.get<string>('jwt.refreshExpiresIn') || '1d') as any;
