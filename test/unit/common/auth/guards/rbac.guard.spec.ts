...
describe('RbacGuard', () => {
  ...
  let orchestrator: RbacAuthorizationOrchestrator;
  ...
  beforeEach(async () => {
    const module: TestingModule = await Test.createTestingModule({
      providers: [
        ...
        {
          provide: RbacAuthorizationOrchestrator,
          useValue: {
            resolveActiveGroupScopeForRbac: jest.fn(),
          },
        },
      ],
    }).compile();
  ...
  describe('canActivate', () => {
    ...
    it('should allow if user-level permission only', async () => {
