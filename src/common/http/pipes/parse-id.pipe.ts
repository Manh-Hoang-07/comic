...
@Injectable()
export class ParseIdPipe implements PipeTransform<string | number, string | bigint | number> {
    transform(value: string | number): string | bigint | number {
        ...
        try {
            ...
            throw new BadRequestException('Validation failed (BigInt string is expected for ID)');
        }
    }
}
